...
namespace InplayBet.Web.Utilities.Expression
{
    ...
    public static class ExpressionBuilder
    {
        ...
        /// <summary>
        /// Tries the assign binary op arguments.
        /// </summary>
        /// <param name="leftArgTokens">The left argument tokens.</param>
        /// <param name="rightArgTokens">The right argument tokens.</param>
        /// <param name="contexts">The contexts.</param>
        /// <param name="recommendedType">Type of the recommended.</param>
        /// <param name="argLeft">The argument left.</param>
        /// <param name="argRight">The argument right.</param>
        /// <returns></returns>
